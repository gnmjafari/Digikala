    ...
    <>
      ...
      <div className="contianerYourvisits">
        <div className="BoxYourvisits">
          <h3>گوشی موبایل</h3>
          <span>براساس بازدید های شما</span>
            ...
            return (
              <a href="">
                ...
                <div>
                  ...
                  <span style={{ color: "black" }}>{item.price} تومان</span>
                </div>
                <p>{item.oldprice}</p>
              </a>
            );
      ...
      <div className="BoxReading" dir="rtl">
        <div>
          <a href="">
            ...
            <p>هنگ درام نیتراید یا استیل؟</p>
          </a>
        </div>
        <div>
          <a href="">
            <img src={image130} alt="" />
            <p>بررسی ظرف غذای برقی درما مدل DG15؛ طراحی خلاقانه و کاربردی</p>
          </a>
        </div>
        <div>
          <a href="">
            <img src={image131} alt="" />
            <p>ناسا سپر حرارتی بادی خود را در مدار آزمایش کرد</p>
          </a>
        </div>
        <div>
          <a href="">
            <img src={image132} alt="" />
            <p>تاگ کارخانه خودروسازی خود را در ترکیه افتتاح کرد</p>
          </a>
        </div>
      </div>
    </>
