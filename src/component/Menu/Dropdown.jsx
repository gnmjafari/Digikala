      ...
      >
        {DropdownData.map((item, index) => {
          if (item.Titel === "موبایل") {
            return (
              <li
                className="categorymenutitel"
                key={index}
                onClick={() => setdropdown(false)}
                onMouseEnter={() => setmenumobil(true)}
                onMouseLeave={() => setmenumobil(false)}
              >
                {item.Titel}
          ...
          if (item.Titel === "کالای دیجیتال") {
            return (
              <li
                ...
                key={index}
                onClick={() => setdropdown(false)}
                onMouseEnter={() => setShowMenuDigitalproduct(true)}
                onMouseLeave={() => setShowMenuDigitalproduct(false)}
              >
                {item.Titel}
